...
public class MainFeedFragment extends Fragment {
    ...
    private RecyclerViewTripAdapter.OnTripDetailsClickListner mOnTripDetailsClickListner;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerViewTtip = (RecyclerView) view.findViewById(R.id.recycler_view_item);
    ...
    private void display_mainfeed(){
        ...
        RecyclerViewTripAdapter mRecyclerViewTripAdapter = new RecyclerViewTripAdapter(mContext, mTrips, mOnTripDetailsClickListner);
...
/*
    ...
    public void onAttach(Context context) {
        try{
            mOnTripDetailsClickListner = (RecyclerViewTripAdapter.OnTripDetailsClickListner) getActivity();
