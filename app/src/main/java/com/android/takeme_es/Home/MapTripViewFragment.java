...
import com.android.takeme_es.Profile.ProfileRecyclerViewLocationAdapter;
...
public class MapTripViewFragment extends Fragment implements OnMapReadyCallback {
...
//        setCameraView();
    ...
    private void setCameraView() {
        ...
        double bottomBoundary = mTrip.getCoordinates().getLatitude() - .1;
        double leftBoundary = mTrip.getCoordinates().getLongitude() - .1;
        double topBoundary = mTrip.getCoordinates().getLatitude() + .1;
        double rightBoundary = mTrip.getCoordinates().getLongitude() + .1;
